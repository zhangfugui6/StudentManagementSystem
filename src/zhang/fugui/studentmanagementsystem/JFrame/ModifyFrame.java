...
public class ModifyFrame extends JDialog{
	...
	private JComboBox sex_Box;
	private JComboBox major_Box;
	private JComboBox department_Box;
	private JLabel student_ID;
	private JLabel student_Name;
	private JLabel sex_Label;
	private JLabel classe_Label;
	...
	private JComboBox classe_Box;
	private JComboBox grade_Box;
	private JDialog jd;
	private HashMap<String, String> departments;
	private HashMap<String, String> all_Major;
	private Vector<String> majors;
	...
	public ModifyFrame(JDialog owner, String title, boolean modal,int rowNum,StudentModel sm){
		...
		grade_Box = new JComboBox(ToolUtil.CreateGrade());
		...
		modify_Button.setBounds(150, 330, 60, 25);
		...
		modify_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String ID = ToolUtil.CreateID(grade, classe, major_ID, department_ID, id);//生成学号

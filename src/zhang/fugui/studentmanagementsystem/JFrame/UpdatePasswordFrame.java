...
public class UpdatePasswordFrame extends JDialog{
	...
	public UpdatePasswordFrame(JFrame owner, String title, boolean modal,User user){
		...
		password_Label.setFont(new Font("黑体",Font.BOLD,12));
		...
		newpassword_Label.setFont(new Font("黑体",Font.BOLD,12));
		...
		repassword_Label.setFont(new Font("黑体",Font.BOLD,12));
		...
		confirm_Button.setFont(new Font("黑体",Font.BOLD,12));
		//注册"确认"按钮事件监听。
		...
		cancel_Button.setFont(new Font("黑体",Font.BOLD,12));
		//注册"取消"按钮事件监听。
